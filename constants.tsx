...
export const APP_URL = 'https://way-1111.vercel.app/';
export const QR_CODE_DATA_URL = 'data:image/png;base64,';
...
export const STRINGS = {
    ar: {
        ...
        jarvisAi: 'الباحث IA',
        jarvisDescription: "أنا الباحث IA، مساعدك الذكي في منصة 'جامعتك الرقمية way'. أقدم استشارات أكاديمية للطلاب بالاعتماد على مصادر البحث الجزائرية، وعلى رأسها منصة ASJP.",
        askJarvis: 'اسأل الباحث IA...',
        ...
        deleteMessageConfirmTitle: 'تأكيد حذف الرسالة',
        deleteMessageConfirmMessage: 'هل أنت متأكد أنك تريد حذف هذه الرسالة نهائياً؟',
    ...
    en: {
        ...
        jarvisAi: 'Al-Bahith IA',
        jarvisDescription: "I am Al-Bahith IA, your smart assistant on the 'Your Digital University Way' platform. I provide academic consultations for students, relying on Algerian research sources, especially the ASJP platform.",
        askJarvis: 'Ask Al-Bahith IA...',
        ...
        deleteMessageConfirmTitle: 'Confirm Message Deletion',
        deleteMessageConfirmMessage: 'Are you sure you want to permanently delete this message?',
    ...
    fr: {
        ...
        jarvisAi: 'Al-Bahith IA',
        jarvisDescription: "Je suis Al-Bahith IA, votre assistant intelligent sur la plateforme 'Votre Université Numérique Way'. Je fournis des consultations académiques aux étudiants, en m'appuyant sur les sources de recherche algériennes, notamment la plateforme ASJP.",
        askJarvis: 'Demandez à Al-Bahith IA...',
        ...
        deleteMessageConfirmTitle: 'Confirmer la suppression du message',
        deleteMessageConfirmMessage: 'Êtes-vous sûr de vouloir supprimer définitivement ce message ?',
